...
export default {
    ...
    async created() {
        try {
            ...
            const response = await axios.get('http://api.local-shyphem.site/users/profile', {
            ...
            const annoncesResponse = await axios.get('http://api.local-shyphem.site/annonces/user', {
                withCredentials: true,
            });
    ...
    methods: {
        async deleteAccount() {
            try {
                ...
                await axios.delete('http://api.local-shyphem.site/users/profile', {
                    withCredentials: true,
                });
