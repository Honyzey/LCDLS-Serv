...
export default {
    ...
    methods: {
        async fetchCategories() {
            try {
                const response = await axios.get('http://api.local-shyphem.site/annonces/categories');
        ...
        async fetchEtats() {
            try {
                const response = await axios.get('http://api.local-shyphem.site/annonces/etats');
        ...
        async submitAnnonce() {
            ...
            try {
                ...
                const response = await axios.post('http://api.local-shyphem.site/annonces', formData, {
                    headers: {
